...
class down1:
    async def down(message : types.Message, state: FSMContext):
        '''нахождение всей литературы в художественном разделе и выдача пользователю'''
        async with aiohttp.ClientSession() as session:
            str = 'http://tolstoy.ru/creativity/fiction/'
    ...
    def register_commands(dp: Dispatcher):
        '''обработчик команд'''
        dp.register_message_handler(down1.down, commands=['Fiction'])
